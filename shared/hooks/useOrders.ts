...
import { fetchOrders, removeOrder, updateOrderStatus } from "../api/orders";
import { OrdersContext } from "../contexts/OrdersContext";
import { DataStatus, Order, OrderFilter, TodayStats } from "../types/order";
...
export function useOrders(): UseOrdersReturn {
  ...
  const todayStats = useMemo(
    () => computeTodayStats(state.orders),
    [state.orders],
  );
